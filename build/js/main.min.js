...
var _initVideo = _interopRequireDefault(require("./modules/init-video"));
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    window.form = form;
    form.init();
    (0, _initVideo.default)();
    (0, _initTabs.initTabs)();
    (0, _initSlider.initTrainerSwiper)();
...
},{"./modules/form-validate/form":3,"./modules/init-slider":9,"./modules/init-tabs":10,"./modules/init-video":11,"./utils/ios-vh-fix":13,"./vendor/swiper":14}],2:[function(require,module,exports){
"use strict";
...
function addTabindex() {
  var originalSlides = document.querySelectorAll('.trainer__item:not(.swiper-slide-duplicate)');
...
var initTrainerSwiper = function initTrainerSwiper() {
  var container = document.querySelector('.swiper--trainer');
  if (!container) {
    return null;
  }
  var TrainerSwiper = new window.Swiper('.swiper--trainer', {
...
var initReviewsSwiper = function initReviewsSwiper() {
  var container = document.querySelector('.reviews__slider');
  if (!container) {
    return null;
  }
...
var handleControlClick = function handleControlClick(evt, controls, elements, parent) {
  var target = evt.target;
  var elementContent = target.dataset.content;
  var correspondingTab = parent.querySelector("[data-element-content=\"".concat(elementContent, "\"]"));
  if (!correspondingTab) {
  ...
  if (tabsParentElement) {
    ...
    if (tabsControls && tabsControls.length && tabsElementsList && tabsElementsList.length) {
      tabsControls.forEach(function (control) {
        var elementContent = control.dataset.content;
        var correspondingTab = tabsParentElement.querySelector("[data-element-content=\"".concat(elementContent, "\"]"));
        if (!correspondingTab) {
