...
},{"./modules/form-validate/form":3,"./modules/modals/init-modals":9,"./utils/init-slider":12,"./utils/init-tabs":13,"./utils/init-video":14,"./utils/ios-vh-fix":16,"./vendor/swiper":18}],2:[function(require,module,exports){
"use strict";
...
var initTrainerSwiper = function initTrainerSwiper() {
  var trainerSlider = new Swiper('.swiper--trainer', {
    // eslint-disable-line
...
var onControlClick = function onControlClick(evt, controls, elements, parent) {
  var target = evt.target;
